 ...
 *  Compilation:  javac Conv_b_lbs.java
 *  Execution:    java Conv_b_lbs port
 *
 *  % java Conv_b_lbs portnum
 ******************************************************************************/
...
public class Conv_b_lbs {
    ...
    private static void process (Socket clientSocket) throws IOException {
        ...
        //     out.println("Invalid Input!");
            ...
            if (tokens[0].equals("b") && tokens[1].equals("lbs")){
                result = num /3;
                out.println(result + " pounds");
